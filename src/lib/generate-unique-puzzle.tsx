/**
 * https://github.com/raravi/sudoku/tree/master/src/solver
 ...
 */
 ...
 /**
	...
	*/
 function _generateUniqueSudoku(solvedArray: string[], difficulty: string) {
 ...
 export const generateSudoku = (difficulty: Difficulty) => {
	 ...
	 return [temporaryInitArray.join('').replaceAll('0','.'), temporarySolvedArray.join('')];
 }